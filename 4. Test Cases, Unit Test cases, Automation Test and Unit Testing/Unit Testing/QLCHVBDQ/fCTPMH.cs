...
namespace QLCHVBDQ
{
    public partial class fCTPMH : Form
    {
        ...
        public void dtgvChiTietPMH_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
        ...
        public void fCTPMH_Load(object sender, EventArgs e)
        {

        }

        public void dtgvChiTietPMH_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
